                                       ...
                                       target_ulong *val)
{
    ...
    *val = THEAD_MXSTATUS_UCME | THEAD_MXSTATUS_THEADISAEE;
    return RISCV_EXCP_NONE;
}
...
#define TH_C910_MXSTATUS_WRITABLE \
    (THEAD_MXSTATUS_THEADISAEE | THEAD_MXSTATUS_MAEE | \
     ...
     THEAD_MXSTATUS_UCME | THEAD_MXSTATUS_MM | THEAD_MXSTATUS_PMDM | \
     THEAD_MXSTATUS_PMDS | THEAD_MXSTATUS_PMDU)
#define TH_C910_MXSTATUS_RESET \
    (THEAD_MXSTATUS_THEADISAEE | THEAD_MXSTATUS_MAEE | \
     TH_MXSTATUS_CLINTEE | THEAD_MXSTATUS_UCME | THEAD_MXSTATUS_MM)
